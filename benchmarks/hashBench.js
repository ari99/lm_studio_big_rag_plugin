...
const hashFile = nativeModule?.hashFile;
const hashFilesParallel = nativeModule?.hashFilesParallel;

// Generate test files
function createTestFile(dir, name, sizeKB) {
...
function createTestFiles(dir, count, sizeKB) {
...
async function hashFileTS(filePath) {
...
async function hashFileTSReadFile(filePath) {
