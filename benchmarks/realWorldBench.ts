...
import { calculateFileHash as tsHashFile, isNativeHashingAvailable } from "../src/utils/fileHash";
import { chunkText as tsChunkText, isNativeChunkingAvailable } from "../src/utils/textChunker";
import { scanDirectory as tsScanDir, isNativeScanningAvailable } from "../src/ingestion/fileScanner";
import { 
...
async function main() {
  ...
  console.log(`  Hashing: ${isNativeHashingAvailable()}`);
